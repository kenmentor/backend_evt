...
import { requst_service } from "../service";
import { response } from "../utility";
const { goodResponse, badResponse } = response;

const create_request = async (req: Request, res: Response) => {
  const body = req.body;
  try {
...
const delete_request = async (req: Request, res: Response) => {
...
const update_request = async (req: Request, res: Response) => {
...
const get_request_details = async (req: Request, res: Response) => {
...
const get_all_request = async (req: Request, res: Response) => {
